...
describe('module validators', () => {
  test.each([
    { value: '11111111111111', cardInfo: { start: 21, length: 14 }, expected: false },
    { value: '11111111111111', cardInfo: { start: 1, length: 13 }, expected: false },
    { value: '11111111111111', cardInfo: { start: 1, length: 14 }, expected: true },
